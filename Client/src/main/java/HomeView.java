...
public class HomeView {
    ...
    private void createGui() {
        ...
        for (Button b : new Button[]{playRandom, createRoom, joinRoom, watchMatch, playBot, communityBtn, readRules}) {
            b.setMinWidth(200);
        ...
        rulesBox.setStyle("-fx-background-color: #1E293B; -fx-padding: 30; -fx-background-radius: 10; -fx-border-color: #334155; -fx-border-width: 2;");
        ...
        globalChatBox.setStyle("-fx-background-color: #1E293B; -fx-padding: 30; -fx-background-radius: 10; -fx-border-color: #334155; -fx-border-width: 2;");
        ...
        leftSidebar.getChildren().addAll(playRandom, createRoom, joinRoom, watchMatch, playBot, communityBtn, readRules);
    ...
    private GridPane createStaticBoard() {
        ...
        board.setHgap(0); board.setVgap(0);
        board.setAlignment(Pos.CENTER);
        board.setStyle("-fx-background-color: #5C3A21; -fx-background-radius: 8; -fx-border-color: #3B2313; -fx-border-width: 5; -fx-border-radius: 8; -fx-padding: 15;");
